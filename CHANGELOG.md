...
All notable changes to the AIUB Portal+ extension will be documented in this file.

## [1.5.0] - 2026-04-24
### Added
- **Rebranding:** Extension renamed from AIUB+ to **AIUB Portal+**.
...
- Refined autofill detection to support browser-built-in password managers more reliably.

## [1.0.0] - 2026-04-22
### Added
- Initial release with basic captcha solving and auto-login logic.
